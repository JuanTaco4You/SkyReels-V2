...
Check **Use Prompt Enhancer** to automatically expand short prompts with Qwen2.5.
A dedicated **Prompt Enhancer** button opens a small window to run the enhancer on its own.
